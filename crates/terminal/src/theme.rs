...
impl Default for TerminalTheme {
    fn default() -> Self {
        Self {
            ...
            search_match_bg: Color32::from_rgba_unmultiplied(255, 200, 50, 120),
            search_match_fg: Color32::BLACK,
        }
    }
}
        ...
        match c {
            ...
            ansi::Color::Indexed(index) => {
                if index <= 15 {
                    ...
                    return hex_to_color(color).unwrap_or(Color32::BLACK);
                }
            ...
            ansi::Color::Named(c) => {
                ...
                hex_to_color(color).unwrap_or(Color32::BLACK)
            }
        }
    }
}
