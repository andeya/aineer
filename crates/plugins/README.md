...
This crate provides plugin discovery, installation, lifecycle management, and the hook execution framework that allows extending Codineer with third-party tools and workflows.
