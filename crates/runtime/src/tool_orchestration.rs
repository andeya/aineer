...
///
/// Backed by [`Arc`]`<`[`AtomicBool`]`>` (same pattern as [`codineer_core::cancel::CancelToken`]).
#[derive(Debug, Clone)]
...
/// [`ExecuteBatchOptions::on_tool_progress`] (callers often emit [`codineer_core::events::RuntimeEvent::ToolProgress`]).
