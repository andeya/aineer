...
This crate provides the LSP transport layer used by Codineer to communicate with language servers, enabling features like diagnostics, completions, and code navigation.
