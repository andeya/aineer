...
mod tests {
    ...
    fn wrap_long_path_splits_at_slash() {
        // "codineer --resume ~/.codineer/sessions/session-12345"
        // With width=30 the soft break at '/' should be preferred.
        let s = "codineer --resume ~/.codineer/sessions/session-12345";
    ...
    fn wrap_all_lines_within_max_width() {
        let s = "codineer --resume ~/.codineer/sessions/session-1775379683907";
