...
> **此文档为 GPUI 时代的旧版设计方案，已不再维护。**
> 当前有效的设计文档位于：[`docs/design/aineer-product-tech-design.md`](../../docs/design/aineer-product-tech-design.md)
> 项目已从 GPUI 迁移至 **Tauri 2 + React 19 + shadcn/ui + Prompt Kit** 架构。

---

# Aineer 产品与技术设计方案（旧版，仅供参考）
